    ...
    <main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 lg:mt-32">
      <div class="lg:grid lg:grid-cols-12 lg:gap-8">
        <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
          <h1>
            <span class="block text-sm font-semibold uppercase tracking-wide text-gray-500 sm:text-base lg:text-sm xl:text-base">Blühpatenschaft</span>
            <span class="mt-1 block text-2xl tracking-tight font-extrabold sm:text-3xl xl:text-4xl">
              <span class="block text-gray-900">Es blüht immer weniger</span>
              <span class="block text-indigo-600">Wir ändern das!</span>
            </span>
          </h1>
        ...
        <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
            <div class="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
                <div class="space-y-5 sm:space-y-4">
                    <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl">Das sind wir</h2>
                    <p class="text-xl text-gray-500">Wir sind ein Familienbetrieb in der X. Generation.</p>
                    <p class="text-xl text-gray-500">Ackerbau, Tierhaltung.</p>
                </div>
                        ...
                        <li>
                            <div class="space-y-4">
                                <div class="aspect-w-3 aspect-h-2">
                                    <img class="object-cover shadow-lg rounded-lg" src="https://images.unsplash.com/photo-1505840717430-882ce147ef2d?ixlib=rb-1.2.1&ixqx=ouvg2vmELK&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80" alt="">
                                </div>
